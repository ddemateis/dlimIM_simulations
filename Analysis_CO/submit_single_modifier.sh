...
#SBATCH --job-name=sing_mod_ES							# Job name
...
#SBATCH --array=0-13							 	# Array indices for each modifier 
...
# Launch a serial job
echo "Starting @ "`date`
Rscript analysis_script_CO_single_modifier_models.R $SLURM_ARRAY_TASK_ID
echo "Completed @ "`date`