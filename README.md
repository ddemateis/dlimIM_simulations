# dlimIM_simulations
The repository contains scripts to recreate the simulations and analyses in "Distributed Lag Interaction Model with Index Modification" to be submitted to Biostatistics. Files are named according to which figure/table they recreate. 
...
To run the simulation_script.R, use the submit_all.sh script on a HPC using the sbatch command. 
