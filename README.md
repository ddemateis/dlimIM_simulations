...
The analysis was completed with version 0.1.0 of the R package dlimIM available at https://github.com/ddemateis/dlimIM/releases/tag/v0.1.0. 
For completeness, the file dlimIM-0.1.0.tar included in this repository contains an archived version of that package.
